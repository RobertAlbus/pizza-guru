...
My implementation formalizes the ideas of Pipelines and Pipeline Stages as classes. Pipelines are recursively composable they execute a list of IPipelineStages and they are themselves an implementation of IPipelineStage.
